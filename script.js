window.onload = function(){
    ...
    const tools = {
        "upload" : function(){
            ...
            // creating an input element which has type = file because i want the user to input an image 
            upload.click()
    ...
    //  this loop traverses on all the button and 
    // nodeName return the tag (ex - for p tag it will return P)
